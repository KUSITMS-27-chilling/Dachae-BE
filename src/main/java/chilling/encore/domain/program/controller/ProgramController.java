package chilling.encore.domain.program.controller;

import chilling.encore.domain.program.dto.ProgramDto.AllProgramInCenter;
import chilling.encore.domain.program.dto.ProgramDto.AllProgramMainResponses;
import chilling.encore.domain.program.dto.ProgramDto.NewProgramsResponse;
import chilling.encore.domain.program.dto.ProgramDto.PagingPrograms;
import chilling.encore.global.dto.ResponseDto;
import chilling.encore.domain.program.service.ProgramService;
...
import static chilling.encore.domain.program.constant.ProgramConstant.SuccessMessage.SELECT_NEW_SUCCESS;
import static chilling.encore.domain.program.constant.ProgramConstant.SuccessMessage.SELECT_PROGRAM_SUCCESS;
