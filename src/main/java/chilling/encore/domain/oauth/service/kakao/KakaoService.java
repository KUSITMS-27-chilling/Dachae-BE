package chilling.encore.domain.oauth.service.kakao;

import chilling.encore.domain.user.entity.User;
import chilling.encore.domain.user.dto.UserDto.UserLoginResponse;
...
import chilling.encore.domain.oauth.dto.Oauth2SignUpResponse;
import chilling.encore.domain.oauth.dto.kakao.KakaoResponseInfo;
...
import static chilling.encore.domain.user.constant.UserConstants.SuccessMessage.LOGIN_SUCCESS;
import static chilling.encore.domain.user.constant.UserConstants.SuccessMessage.SIGNUP_CONTINUE;
